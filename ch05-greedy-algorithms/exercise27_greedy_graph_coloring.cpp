// g++ exercise27_greedy_graph_coloring.cpp - o exercise27_greedy_graph_coloring.exe
// exercise27_greedy_graph_coloring.exe
...
template<typename T> auto greedy_coloring(const Graph<T>& G)
{
	...
	for (auto i = 1; i < size; i++)
	{
		...
		for (; smallest_unassigned_color <= color_map.size(); smallest_unassigned_color++)
		{
			if (neighbour_colors.find(smallest_unassigned_color) == neighbour_colors.end())
				break;
		}
