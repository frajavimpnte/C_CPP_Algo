// g++ exercise28_breadth_first_search.cpp -o exercise28_breadth_first_search.exe
// exercise28_breadth_first_search.exe
...
then iteratively exploring the vertices adjacent to the current frontier.
...
vertex are always visited before the vertices that are farther away.
*/
...
template <typename T> auto breadth_first_search(const Graph<T>& G, size_t dest)
{
...
template <typename T> void test_BFS()
{
