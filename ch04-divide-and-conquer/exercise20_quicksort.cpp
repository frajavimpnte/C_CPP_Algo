// g++ exercise20_quicksort.cpp -o exercise20_quicksort.exe
// exercise20_quicksort.exe
...
template <typename T> auto partition(typename std::vector<T>::iterator begin, typename std::vector<T>::iterator last)
{
	// Create 3 iterators,
...
template <typename T> void quick_sort(typename std::vector<T>::iterator begin, typename std::vector<T>::iterator last)
{
