// g++ exercise18_binary_search.cpp -o exercise18_binary_search.exe
// exercise18_binary_search.exe

// STL distance. The std::distance() in C++ STL is a built-in function used to calculate the number 
//				 of elements between two iterators. It is defined inside <iterator> header file.  

// STL advance. template  void advance (InputIterator& it, Distance n);
